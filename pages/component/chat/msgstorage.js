let Disp = require("../../../utils/huanxinIM/Dispatcher");
...
msgStorage.saveReceiveMsg = function(receiveMsg, type){
	console.log("你觉得在这里",receiveMsg, type)
	let sendableMsg;
...
msgStorage.saveMsg = function(sendableMsg, type, receiveMsg){
	console.log('sendableMsgsendableMsg', sendableMsg,type, receiveMsg)
	let me = this;
	...
	function save(){
		wx.setStorage({
			...
			success(){
				...
				console.log("这个是好事情",renderableMsg, type, curChatMsg, sessionKey)
			}
		});
	}
};
