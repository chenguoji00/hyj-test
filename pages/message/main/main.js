...
Page({
  ...
  onSearch: function (val) {
    ...
    let serchList = [];
    console.log(this.data.member, "asd");
  ...
  getBrands: function (member) {
    ...
    member = [{
      ...
      groups: [],
      jid: {
        appKey: "easemob-demo#chatdemoui_zdtest2@easemob.com",
        clientResource: "webim_1590388258470",
        domain: "easemob.com",
        name: "chenguojiqq"
      },
      name: "adtest2",
    ...
    someArr = [{
        ...
        brands: [{
            brandId: {
              ...
              clientResource: "webim_1590387792233",
              domain: "easemob.com",
              name: "chenguojiqq"
            },
            name: "阿明"
          },
          {
            brandId: {
              appKey: "easemob-demo#chatdemoui",
              clientResource: "webim_159038779a2233",
              domain: "easemob.com",
              name: "chenguojiqq"
            },
            name: "奥特曼"
          },
          {
            brandId: {
              appKey: "easemob-demo#chatdemoui",
              clientResource: "webim_1590e387792233",
              domain: "easemob.com",
              name: "chenguojiqq"
            },
            name: "安庆"
          },
          {
            brandId: {
              appKey: "easemob-demo#chatdemoui",
              clientResource: "webim_15903877r92233",
              domain: "easemob.com",
              name: "chenguojiqq"
            },
            name: "阿曼"
      ...
      },
      {
        ...
        brands: [{
            brandId: {
              appKey: "easemob-demo#chatdemoui",
              clientResource: "webim_15903877f92233",
              domain: "easemob.com",
              name: "chenguojiqq"
            },
            name: "陈国基"
          },
          {
            brandId: {
              appKey: "easemob-demo#chatdemoui",
              clientResource: "webim_159035487792233",
              domain: "easemob.com",
              name: "chenguojiqq"
            },
            name: "css"
          },
          {
            brandId: {
              appKey: "easemob-demo#chatdemoui",
              clientResource: "webim_159038779252233",
              domain: "easemob.com",
              name: "chenguojiqq"
            },
            name: "侧耳"
          },
          {
            brandId: {
              appKey: "easemob-demo#chatdemoui",
              clientResource: "webim_159038779211233",
              domain: "easemob.com",
              name: "chenguojiqq"
            },
            name: "城管委"
      ...
      },
      {
        ...
        brands: [{
            brandId: {
              appKey: "easemob-demo#chatdemoui",
              clientResource: "webim_159038z77f92233",
              domain: "easemob.com",
              name: "chenguojiqq"
            },
            name: "颍风"
    ...
    console.log(someArr, "this is someArr")
